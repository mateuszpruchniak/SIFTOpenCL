...
static struct kd_node* kd_node_init( feature*, int );
...
static struct kd_node* explore_to_leaf( struct kd_node*, feature*,
										struct min_pq* );
...
@return Returns the number of neighbors found and stored in nbrs, or
	-1 on error.
*/
int kdtree_bbf_knn( struct kd_node* kd_root, feature* feat, int k,
					feature*** nbrs, int max_nn_chks )
{
	struct kd_node* expl;
...
*/
int kdtree_bbf_spatial_knn( struct kd_node* kd_root, feature* feat,
						   int k, feature*** nbrs, int max_nn_chks,
						   CvRect rect, int model )
{
	feature** all_nbrs, ** sp_nbrs;
	CvPoint2D64f pt;
	int i, n, t = 0;
...
@return Returns a pointer to the leaf node at which exploration ends or
	NULL on error.
*/
static struct kd_node* explore_to_leaf( struct kd_node* kd_node, feature* feat,
										struct min_pq* min_pq )
{
...
@return If feat was successfully inserted into nbrs, returns 1; otherwise
	returns 0.
*/
static int insert_into_nbr_array( feature* feat, feature** nbrs,
								  int n, int k )
{
