 ...
 */
 void SIFTOpenCL::ReleasePyr( IplImage**** pyr, int octvs, int n )
 {
	 int i, j;
	 for( i = 0; i < octvs; i++ )
	 {
...
*/
 CvSeq* SIFTOpenCL::ScaleSpaceExtrema( IplImage*** dog_pyr, int octvs, int intvls,
...
*/
int SIFTOpenCL::IsTooEdgeLike( IplImage* dog_img, int r, int c, int curv_thr )
{
...
*/
 int SIFTOpenCL::IsExtremum( IplImage*** dog_pyr, int octv, int intvl, int r, int c )
{
...
*/
 feature* SIFTOpenCL::InterpExtremum( IplImage*** dog_pyr, int octv, int intvl,
...
*/
 ...
 void SIFTOpenCL::InterpStep( IplImage*** dog_pyr, int octv, int intvl, int rr, int cc,
...
*/
 CvMat* SIFTOpenCL::Deriv3D( IplImage*** dog_pyr, int octv, int intvl, int r, int c )
{
	CvMat* dI;
	float dx, dy, ds;
...
@return Returns the Hessian matrix (below) for pixel I as a CvMat*
	...
	\ Ixs  Iys  Iss /
*/
void SIFTOpenCL::Hessian3D( IplImage*** dog_pyr, int octv, int intvl, int r, int c, float H[][3] )
{
...
*/
 float SIFTOpenCL::InterpContr( IplImage*** dog_pyr, int octv, int intvl, int r,
...
*/
 feature* SIFTOpenCL::NewFeature( void )
 {
	feature* feat;
	struct detection_data* ddata;
...
*/
 IplImage*** SIFTOpenCL::BuildDogPyr( IplImage*** gauss_pyr, int octvs, int intvls )
{
	IplImage*** dog_pyr;
	int i, o;
...
*/
 IplImage*** SIFTOpenCL::BuildGaussPyr( IplImage* base, int octvs,
 ...
 */
 IplImage* SIFTOpenCL::Downsample( IplImage* img )
 {
